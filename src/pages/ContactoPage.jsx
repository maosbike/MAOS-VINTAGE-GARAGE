      ...
      <div className="section">
        <div className="grid gap-10 lg:grid-cols-[1fr_360px]">
          <div>
            ...
            <p className="mt-5 max-w-xl font-serif text-xl italic text-ink-soft">
          ...
          <aside className="space-y-4">
            <div className="card overflow-hidden">
              ...
              <ul className="space-y-5 p-5">
                <li>
                  <a href="https://wa.me/56900000000" target="_blank" rel="noreferrer noopener" className="flex items-start gap-3 text-ink hover:text-cognac">
                    <MessageCircle size={20} className="mt-0.5 text-cognac" aria-hidden="true" />
                    <span>
                      <span className="block font-mono text-[10px] font-bold uppercase tracking-widest2 text-ink-faint">WhatsApp</span>
                      <span className="font-serif text-base">+56 9 0000 0000</span>
                    </span>
                  </a>
                </li>
                <li>
                  <a href="mailto:hola@maoscars.cl" className="flex items-start gap-3 text-ink hover:text-cognac">
                    <Mail size={20} className="mt-0.5 text-cognac" aria-hidden="true" />
                    <span>
                      <span className="block font-mono text-[10px] font-bold uppercase tracking-widest2 text-ink-faint">Email</span>
                      <span className="font-serif text-base">hola@maoscars.cl</span>
                    </span>
                  </a>
                </li>
                <li className="flex items-start gap-3 text-ink-soft">
                  <MapPin size={20} className="mt-0.5 text-cognac" aria-hidden="true" />
                  <span>
                    <span className="block font-mono text-[10px] font-bold uppercase tracking-widest2 text-ink-faint">Oficina</span>
